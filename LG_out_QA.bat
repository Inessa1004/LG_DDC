...
java -jar \\lpiway02\JavaDist\sendmail.jar inesa.l@sapiens.com  inesa.l@sapiens.com,yehuda.m@sapiens.com,Yaron.Muchnik@sapiens.com,Ofer.Shamir@sapiens.com,Ron.Koifman@sapiens.com "tamlogver LG sent to FTP" "LG sent to ftp, mail text is attached" "c:\TAMLOG\commands\LG_mail_new.txt"
